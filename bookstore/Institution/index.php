				...
				<div class="col-lg-12">
					<div class="box">
						<div class="box-header">
							<h2><i class="icon-edit"></i>Create a Institution</h2>
						...
						<div class="box-content">
							<form class="form-horizontal" action="instiaction.php" method="post">
							  <fieldset class="col-sm-12">	



							<div class="form-group has-success">
								  <label class="control-label" for="inputSuccess">Institute Name</label>
								...
								<div class="form-actions">
								  <button type="submit" class="btn btn-primary">Create Insti</button>
