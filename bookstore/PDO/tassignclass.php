				...
				<div class="col-lg-12">
					<div class="box">
						<div class="box-header">
							<h2><i class="icon-edit"></i>Assign Teacher to a Class</h2>
						...
						<div class="box-content">
							<form class="form-horizontal" action="tassignaction.php" method="post">
...
?>
							...
							<div class="form-group">
	<label class="control-label" for="selectErrorT">Select Teacher</label>
		<div class="controls">
...
$i_id = $institute['_id'];
$I_PDOs = AllInstiRolePDO("$i_id","Staff");
...
<div class="form-group">
	<label class="control-label" for="selectErrorT">Select Course/Courses to Assign</label>
		<div class="controls">
		  <select name="courses[]" id="selectErrorT" class="form-control" multiple data-rel="chosen">
								
<?php
include_once(dirname(__FILE__) . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'functions/cfunctions.php');
$Co_Class = CoursesInClass('534a5d4ad1f73c88078b4567');


foreach($Co_Class as $Course){
echo '<option value="'.$Course.'">'.CourseName($Course).'</option>';
}
