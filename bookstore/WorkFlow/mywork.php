				...
				<div class="col-lg-12">
					<div class="box">
						<div class="box-header" data-original-title>
							<h2><i class="icon-user"></i><span class="break"></span>Hello <?php echo $m->getUserfirstname().'&nbsp;'.$m->getUserlastname(); ?>,&nbsp; Your Total Workflow</h2>
							<div class="box-icon">
...
getcompletework($_SESSION['uid']);
global $completework;
foreach($completework as $document){
...
echo " 
<tr> <td> ".getsecname($document['sec_id'])."</td><td> ".getcoursename($document['course'])."</td>
									<td>".$document['worktype']."</td>
									<td class='center'>".$document['date']."</td>
						<td class='center'>".tidtodetails($document['course'], $document['topic'][$k])."</td>
									<td class='center'> 
