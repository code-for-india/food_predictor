...
function createbook($bname,$bnumber,$bauthor,$bpublisher,$bcatogery)
	{
...
$insertion =	SaveCollection('books',$books);
if($insertion){
return 1;
}
else{
...
$create = createbook($_POST['bname'],$_POST['bnumber'],$_POST['bauthor'],$_POST['bPublisher'],$_POST['bcatogery']);
